...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Browser will redirect to Google automatically — isLoading stays true until navigation
    } catch (error: any) {
              ...
              <div className="flex flex-col gap-6">
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full bg-transparent opacity-40 cursor-not-allowed"
                    disabled
                    title="Недоступно"
                  >
                ...
                <div className="relative flex items-center">
                  ...
                  <span className="mx-4 text-sm text-muted-foreground">{t.or}</span>
                  <div className="flex-grow border-t border-muted"></div>
                </div>
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? `${t.signInButton}...` : t.signInButton}
                </Button>
              </div>
