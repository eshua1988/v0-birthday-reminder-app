              ...
              <div className="flex flex-col gap-6">
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  ...
                  >
                    ...
                    <span className="font-medium">Зарегистрироваться через Facebook</span>
                  </Button>
                  ...
                  >
                    ...
                    <span className="font-medium">Зарегистрироваться через Apple</span>
                  </Button>
                </div>
                ...
                <div className="grid gap-2">
                  <Label htmlFor="repeat-password" className="text-sm sm:text-base">Повторите пароль</Label>
                  <div className="relative">
                    <Input
                      id="repeat-password"
